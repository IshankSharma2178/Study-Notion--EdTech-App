      ...
      <div>
        <div className="flex flex-row  w-[100%] gap-4">
          <div className="flex flex-col w-[50%]">
            <label htmlFor="firstname" className="text-richblack-100 pb-2">
              First Name
            </label>
            <input
              type="text"
          ...
          <div className="flex flex-col w-[50%]">
            <label htmlFor="lastname" className="text-richblack-100  pb-2">
              Last Name
            </label>
            <input
              type="text"
        ...
        <div className="flex flex-col">
          <label htmlFor="email" className="text-richblack-100  pb-2 mt-7">
            Email Address
          </label>
          <input
            type="email"
        ...
        <div className="flex flex-col">
          <label htmlFor="message" className="text-richblack-100  pb-2 mt-7">
            Message
          </label>
          <textarea
            type="message"
        ...
        <button
          type="submit"
          className="text-center w-full mt-8 text-[17px] font-semibold text-nowrap px-6 py-3 rounded-md bg-yellow-50 text-black
