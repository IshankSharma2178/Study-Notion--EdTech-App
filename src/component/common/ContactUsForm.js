...
function ContactUsForm() {
    ...
    <form onSubmit={handleSubmit(submitContactForm)}>
        <div className='md:w-[400px] w-[300px ] lg:w-[500px] m-auto flex flex-col gap-y-8 '>
            ...
            <button type="submit" className='text-center text-[17px] font-semibold text-nowrap px-6 py-3 rounded-md bg-yellow-50 text-black
