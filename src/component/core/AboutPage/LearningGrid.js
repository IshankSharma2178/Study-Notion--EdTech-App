        ...
        <div className='grid mx-auto mt-16 lg:mr-10 grid-cols-1 lg:grid-cols-4 mb-12 auto-rows-min'>
            {
                LearningGridArray.map((element,index)=>(
                    element.order ===-1 ?
                    <div key={index} className='lg:col-span-2 lg:w-[90%] lg:mb-0 mb-10 lg:ml-8 min-h-fit'>
                    ...
                    :
                    <div className={`${index%2===0?"bg-richblack-800":"bg-richblack-700"} ${index===3?"lg:col-start-2":""} min-h-[15rem] lg:block hidden lg:pt-10 lg:p-6` } key={index}>
                        <div>
                               <h1 className='text-xl tracking-wide text-richblack-5'>{element.heading}</h1>
                        </div>
